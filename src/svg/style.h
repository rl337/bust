...
namespace bust::svg {
    ...
    struct Style {
        ...
        public:
            Style(std::string n, bust::util::Color f, bust::util::Color s, uint8_t sw, std::string style) : name(n), fill(f), stroke(s), stroke_width(sw), style(style) {};
            Style(std::string n, bust::util::Color f, bust::util::Color s, uint8_t sw) : name(n), fill(f), stroke(s), stroke_width(sw), style("") {};
            ...
            inline std::string getStyle() const { return this->style; }
    };
